...
class Config():
    ...
    def __init__(self, username=None):
        ...
        self.filtered_files = sorted(glob(os.path.join(self.data_path, 'filtered', '*set')))
        self.original_asr_out_files = sorted(glob(os.path.join(self.data_path, 'original ASR out', '*set')))
        self.riemannian_asr_out_files = sorted(glob(os.path.join(self.data_path, 'Riemannian ASR out', '*set')))
        self.calibration_files = sorted(glob(os.path.join(self.data_path, 'calibration data', '*set')))
